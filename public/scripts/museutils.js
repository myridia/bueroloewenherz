...
(function(c) {
    ...
    Muse.Utils.descendants = function(a, b, c, d) {
        ...
        for (var i = 0; i < a.childNodes.length; i++) {
            ...
            l.nodeType == 1 && ((!b || b.matches(l)) && d.push(l), (!c || !c.matches(l)) && Muse.Utils.descendants(l, b, c, d))
        }
        return d
    };
    ...
    Muse.Utils.allStyleSheetRulesFromOneSheet = function(a, b) {
        ...
        if (!g) return null;
        for (var k = [], j = c(window), m = function(a) {
            ...
            if (m(p)) {
                ...
                if (d) b(p.selectorText) &&
                    k.push(p);
                else
                    for (var o = p.selectorText.split(/\s*,\s*/), q = 0; q < o.length; q++) b(o[q]) && k.push(p)
        }
    ...
    Muse.Utils.updateSlideshow_fstpOffsetSize = function(a) {
        ...
        a._fstpOffsetSize = g.transitionStyle === "horizontal" ? g.elastic === "fullWidth" ? Math.max(b.width(), parseInt(d.css("min-width"))) : i.width() : i.height();
        ...
        if (!g || g == "_self") {
            ...
            if (l && g > i) {
                ...
                if (o) {
                    ...
                    if (r && g) return q(), !1;
                    n = r ? l : Math.min(n, c(j).parents(".AccordionWidget").offset().top);
                    p = g ? d : Math.min(p, c(j).parents(".AccordionWidget").offset().left)
                }
                d = function() {
                    m.scrollTo(p, n);
                    o && q();
                ...
                if (window.scrollTo || void 0 !== a) {
                    ...
                    c({
                        ...
                        easing: f,
                        step: function(a) {
                            a != 0 && (x = a * (n - u), t = a * (p - y), m.scrollTo(y + t, u + x))
                        },
                        complete: d
                    })
    ...
    Muse.Utils.enableAnchorLinksActiveState = function() {
        var a = !1,
            ...
            o = function() {
                ...
                var q, t, h = Math.max(0, g);
                for (g = Math.min(g + 2, b.length); h < g; h++)
                    if (q = b[h], o = q.$elem.offset().left + (m && !m.isStandard() ? m.scrollLeft() : 0), t = q.$elem.offset().top + (m && !m.isStandard() ?
                            m.scrollTop() : 0), q.from != (a ? o : t)) {
                        k(p);
                        break
                    } h = 0;
                for (g = b.length; h < g; h++) {
                    ...
                    q = q.hyperLinks;
                    t = void 0;
                    for (var x = 0; x < q.length; x++) t = i(q[x]), o && !q[x].hasClass(t) ? q[x].addClass(t) : !o && q[x].hasClass(t) && q[x].removeClass(t)
                }
            },
            q = function() {
    ...
    Muse.Utils.saveHyperlinkInfo = function(a, b, d, g, i) {
        ...
        if (l && -1 != l.indexOf("#") && !(m && m != "_self") && !(0 <= k.indexOf("/")) && (n.charAt(n.length - 1) == "/" && (n += "index.html"), -1 != n.indexOf("/" + k, n.length - k.length - 1))) {
                ...
                if (!b.data("mu-ie-matrix")) {
                    ...
                    if (!d || !(d.toLowerCase().indexOf("opacity") > 0 && d.indexOf("=100") < 0)) {
                        if (a.childNodes.length && !Muse.Browser.Features.checkCSSFeature("border-radius") && (d = Muse.Utils.firstChild(a, Muse.Utils.Match.byNodeName("img"))) &&
                            ...
                            if ((l == "0px" || l == "auto") && (k == "0px" || k == "auto")) b.addClass("museBGSize"), b.css("background-size", "cover");
                            d.css("visibility", "hidden");
                            b.css("background", i + "url(" + g + ") no-repeat " + l + " " + k)
                        }
                        PIE.attach(a)
                    }
                }
    ...
    Muse.Utils.resizeHeight = function(a) {
        ...
        if (0 < c(".breakpoint").length) c("body").on("muse_bp_activate", function(g, i, l) {
            b = {};
            c(a, l).each(function() {
    ...
    Muse.Utils.adjustTargetAndSlideHeights = function(a, b) {
        ...
        }), i = d == 0 ? g : d, a.children().each(function() {
            if (!c(this).is("img"))
                if (c(this).hasClass("borderbox")) {
                    var a = c(this).outerHeight() - c(this).innerHeight();
                    c(this).css("height", i + a + "px")
                } else a = c(this).innerHeight() - c(this).height(), c(this).css("height", i - a + "px")
        }));
        b === "lightbox" ? a.css("height", i + "px") : a.css("height",
            a.outerHeight() + "px")
    };
    ...
    Muse.Utils.isStackedOrScatteredLayout =
        function(a) {
    ...
    Muse.Utils.fullPage = function(a) {
        ...
        if (0 == c(a).closest(".breakpoint").length) Muse.Assert.assert(0 == c(".breakpoint").length, "Page is outside a breakpoint node."), b.init(c(a));
        else {
            var d = function(d) {
    ...
    Muse.Utils.initWidget = function(a,
        b, d) {
        if (0 == c(".breakpoint").length) c(a).each(function() {
            ...
            for (var g = 0; g < b.length; g++) {
                ...
                Muse.Utils._initWidgetQueue[i].push({
                    id: a,
                    fn: d
                })
            }
                ...
                var l = function(a, b, f, d) {
                    ...
                    if (Muse.Utils._initWidgetQueue[a]) {
                        for (; Muse.Utils._initWidgetQueue[a].length;)
                            if (b =
                                Muse.Utils._initWidgetQueue[a].shift(), b = b.fn(c(b.id, f))) b.$bp = f, b.breakpoint = d;
                        ...
                        if (f) c("body").off("muse_bp_activate", l), Muse.Utils._hasBPListener = !1
                    }
                };
    ...
    Muse.Utils.detachIframesAndObjectsToPauseMedia = function(a) {
        ...
        c("iframe, object", a).each(function() {
            ...
            if (!a.is("object") || !(b.browser.msie && b.browser.version < 9)) {
                ...
                i.$next = a.next();
                i.$parent = a.parent();
                b.browser.msie ? (i.html = a.wrap('<div id="deleteMeWrapper"/>').parent().html(), a.remove(), i.$parent.children("div #deleteMeWrapper").remove()) : (i.$node = a.clone(), a.remove());
                f.push(i)
            }
        });
    ...
    Muse.Utils.getLeft = function(a, b) {
        ...
        if (a.css("position") === "absolute") {
            var i = a.parent();
            if (i && i.hasClass("popup_anchor") && i.css("position") === "relative") d.$element = i, d.left = c(i, "left"), consultMarginLeft = !0
        }
        ...
        if (i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            if (d.$element.css("position") === "static" || d.left === "auto") d.left =
                i;
            else if ((d.left === "0px" || d.left === "0%") && i !== "auto") d.left = i;
        if ((d.$element.css("position") === "static" || d.left === "0px" || d.left === "0%" || d.left === "auto") && i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort) d.left = i;
        return d
    };
    Muse.Utils.getLeftAdjustmentAmountDoneByParents = function(a, b) {
        ...
        d !== void 0 && (d = d.split(","), d = d.filter(function(a, b, c) {
            ...
            if (h[0] !== void 0 && b.closest(h).length) {
                ...
                else if (Muse.Utils.isInPercentage(j) || j === "auto") Muse.Utils.moveElementsOutsideViewport(h), Muse.Utils.moveElementsOutsideViewport(h.parents()), j = Muse.Utils.getPropInPixel(h, "margin-left"), Muse.Utils.isInPixel(j) && j !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort && (g += parseFloat(j)), Muse.Utils.moveElementsInsideViewport(h), Muse.Utils.moveElementsInsideViewport(h.parents())
            }
            return !0
        }));
        return g
            ...
            if (a && a.length > 0) switch (b) {
                case "page_fixedLeft":
                    a.forEach(function(a) {
                        var b = Muse.Utils.getChildWidth(a, c, !0),
                            ...
                            n = 0,
                            p = 0;
                        Muse.Utils.isInPercentage(b) ? (j = parseFloat(b) / 100, b = Muse.Utils.getWidths(a), p = b.elemWidth, f = b.offsetWidth) : Muse.Utils.isInPixel(b) && (j = a.offsetParent().width(), p = parseFloat(b), j = j > 0 ? p / j : 0);
                        j > 0 && (f > Math.round(p) && (n = f - Math.round(p)), b = Math.abs(Muse.Utils.isValueWithinTolerance(j,
                ...
                case "page_fixedRight":
                    a.forEach(function(a) {
                        ...
                        if (f > 0 && f < 1 && !Muse.Utils.isValueWithinTolerance(f, 1, 1.0E-4)) var m = Math.abs(j / (1 - f));
                ...
                case "page_fixedCenter":
                    a.forEach(function(a) {
                        var b = window.getComputedStyle(a[0]).left,
                            ...
                            o = 0,
                            q = 0;
                        if (b !== 0) Muse.Utils.isInPercentage(j) ? m = parseFloat(j) / 100 : Muse.Utils.isInPixel(j) && (m = a.parent().width(), j = parseFloat(j), m = m > 0 ? j / m : 0), Muse.Utils.isInPercentage(n) ? (n = Muse.Utils.getWidths(a), q = n.elemWidth, p = n.offsetWidth) : Muse.Utils.isInPixel(n) && (q = parseFloat(n)), m > 0 && (b > 0 && p > Math.round(q) &&
    ...
    Muse.Utils.computeMinWidthForFixedChilds = function(a, b, d, g) {
        function i(a, b) {
            ...
            Muse.Utils.moveElementsOutsideViewport(a);
            Muse.Utils.moveElementsOutsideViewport(a.parents());
            if (f) f = Muse.Utils.getLeft(a, !0), h = f.$element, i = f.left, l = Muse.Utils.isInPixel(i);
            var r = h.is(g) || g.closest(h).length,
                f = parseFloat(g.width());
            l && (d = parseFloat(i), r || (i = h.parents(), c.each(i, function(a, b) {
                var f = c(b);
                if (f.is(g)) return !1;
        ...
        if (a && a.length > 0) switch (b) {
            case "page_fluidx":
                a.forEach(function(a) {
                    ...
                    c < f + b && (c = f + b);
                    g = c > 0 ? f / c : 0;
                    g < 1 && !Muse.Utils.isValueWithinTolerance(g, 1, 1.0E-4) && (o = Math.abs(b / (1 - g)));
            ...
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1),
                        ...
                        o = 0,
                        q = -1;
                    Muse.Utils.isInPercentage(f) ? o = parseFloat(f) / 100 : Muse.Utils.isInPixel(f) && (o = a.parent().width(), f = parseFloat(f), o =
                        o > 0 ? f / o : 0);
                    o > 0 && (q = Muse.Utils.getLeftAdjustmentAmountDoneByParents(a, g), q = q < 0 ? 0 : q, f = (Math.abs(c) - q) / o, c < 0 ? c += q : c > 0 && (c -= q), Muse.Utils.isValueWithinTolerance(o, 1, 1.0E-4) || (i = (b + c) / (1 - o)), q = Math.max(f, i, b), Muse.Utils.setMinWidthInformation(l, a, q > b ? q : b))
                })
        }
        return l
    };
    Muse.Utils.computeMinWidthForChildsWithMinWidth = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            d !== void 0 && (l = Muse.Utils.computeMinWidthForFixedChilds([a],
    ...
    Muse.Utils.computeMinWidthForForms = function(a) {
        ...
        d.forEach(function(b) {
            ...
            c.each(d, function(b, d) {
                ...
                if (k = parseFloat(h.attr("data-min-width"))) i.chosenMinWidth =
                    Math.max(i.chosenMinWidth, k);
    ...
    Muse.Utils.getMinWidthOfParts =
        function(a, b, d) {
            ...
            if (a && b && !c.isEmptyObject(a) && !c.isEmptyObject(b) && b[0] && a[0]) {
                ...
                m > 0 && (k = "fixed", q = m + s, n = !0, j === void 0 && (j = "page_fluidx"));
                if (k === "fixed") switch (j) {
                    case "page_fluidx":
                        k = -1;
                        o.left <= r.left ? (o = r.left - o.left, o >= 0 && (k = o / p)) : r.left - o.left < 2 && (k = 0);
                        k >= 0 && (Muse.Utils.isValueWithinTolerance(k, 1, 1.0E-4) ?
                            l = 0 : k < 1 && (l = q / (1 - k)));
                        break;
                    case "page_fixedLeft":
                        n || (p = -1, o.left <= r.left ? p = r.left - o.left : r.left - o.left < 2 && (p = 0), p >= 0 && (l = q + p));
                        break;
                    case "page_fixedRight":
                        n || (p = -1, o.right >= r.right ? p = o.right - r.right : o.right - r.right < 2 && (p = 0), p >= 0 && (l = q + p));
                        break;
                    case "page_fixedCenter":
                        n || (p <= q ? l = q : r.left <= o.left || r.right >= o.right ? (p = o.left - r.left, k = r.right - o.right, p >= 0 && k <= 0 ? l = q + (o.right - r.right) : k >= 0 && p <= 0 && (l = q + (r.left - o.left))) : (r = r.left + q / 2, o = o.left + p / 2, p = -1, p = r === o ? 0 : r < o ? o - r : r - o, p >= 0 && (l = 2 * (q / 2 + p))))
                }
    ...
    Muse.Utils.getMinWidthForElement = function(a, b) {
        ...
        if (a && a.length > 0 && a[0].style.minWidth === "" || b) {
            ...
            i.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFluidPin, "page_fluidx", !1, a));
            i.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedLeft, "page_fixedLeft", !1, a));
            i.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedRight, "page_fixedRight", !1, a));
            i.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedCenter, "page_fixedCenter", !1, a));
            i.push(Muse.Utils.computeMinWidthForChildsWithMinWidth(d.ChildWithMinWidth,
                a));
            i.push(Muse.Utils.computeMinWidthForWidgetChilds(d.ChildWidgets, a));
            (d = Muse.Utils.adjustMinWidthRespectToAllParents(a, i)) && d.length > 0 && (c = Math.max.apply(null, d))
        }
        return c
    };
            ...
            var b = [],
                ...
                l = function(a) {
                    ...
                    if (c) {
                        ...
                        for (l = 0; l < b.length;) g = b[l], g.source == a.source && g.method == c.method ? (g.callbackFn(c.value), b.splice(l, 1)) : l++
                    }
                };
            window.addEventListener ? window.addEventListener("message",
                l, !1) : window.attachEvent("onmessage", l, !1);
            l = function() {};
    ...
    (function(a) {
        ...
        l.prototype.activate = function(a) {
            ...
            l.isRetina && (!l.shouldUseCookie || "hidpi" == l.getResolutionPreference()) ? this.hidpiMode(a) : this.standardMode(a)
        };
    ...
    Muse.Utils.readCookie = function(a) {
        ...
        for (var b = document.cookie.split(";"), c = 0; c < b.length; c++) {
            for (var d =
                    b[c]; d.charAt(0) == " ";) d = d.substring(1, d.length);
    ...
    Muse.Browser.Features.checkCSSFeature = function(a, b) {
        ...
        for (var c = c.charAt(0).toUpperCase() + c.substr(1), d = 0, i = Muse.Browser.domPrefixes.length; d < i; d++)
    ...
    (function(a) {
        ...
        d.prototype.init = function(d) {
            ...
            if (0 != this.$verticalSpacer.length) {
                ...
                b.resize(function() {
                    if (k) {
                        var a = b.width();
                        l ? (i.splice(0, i.length), i.push(a), l = !1, setTimeout(function() {
                            l = !0
                        }, 200)) : i[i.length - 1] != a && (i.push(a), 3 < i.length && i[i.length - 3] == i[i.length - 1] && (c.addClass("always_vert_scroll"), k = !1))
                    }
                    j.doUpdate()
                });
                this.doUpdate()
        ...
        0 < k && 0 < j && 300 == j - k ? (l.remove(), l = new d) : (a("html").removeClass("css_verticalspacer"), l = new i);
        ...
        if (-1 != c) {
            ...
            for (var c = document.getElementsByTagName("meta"), b = 0, d = c.length; b < d; b++) {
                ...
                if ("generator" == a.getAttribute("name")) {
                    "2018.1.0.386" != a.getAttribute("content") && Muse.assets.outOfDate.push("museutils.js");
                    break
                }
            }
        }
